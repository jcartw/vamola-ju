...
\begin{cvitems}
\item {Ajudamos o cliente na criação de projetos, contratos, templates e eventos como RFI, RFQ e leilões (japonês,
inglês e holandês), na performance de gerenciamento de Supplier Lifecycle and Performance (SLP) e Supplier
Information and Performance Management (SIPM) na plataforma SAP/Ariba Sourcing.}
\item {Construímos um relacionamento com clientes e fornecedores, ajudando-os a maximizar os benefícios da
solução Ariba, facilitando o intercâmbio global de bens e serviços.}
\end{cvitems}
}
